...
| [0003](0003-qa-architecture.md)                      | QAフレームワークアーキテクチャ                  | Accepted   | 2026-04-15 |
| [0004](0004-template-caching.md)                     | テンプレートマニフェストキャッシング戦略        | Accepted   | 2026-04-16 |
...
A: このプロジェクトでは、ADRは**英語**で記述します。これはプロジェクトの標準に従うためです。ただし、以下の要素は日本語を使用できます：

- コード例内のコメント（明確化のために必要な場合）
- 技術用語（必要に応じて英語の説明を追加）
