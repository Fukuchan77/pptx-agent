...
class TestChartBuilder:
    ...
    def test_add_bar_chart_creates_chart_shape(self, mock_slide):
    ...
    def test_add_line_chart_with_single_series(self, mock_slide):
    ...
    def test_add_pie_chart_creates_chart(self, mock_slide):
    ...
    def test_add_chart_with_invalid_type_raises_error(self, mock_slide):
    ...
    def test_add_chart_with_empty_data_raises_error(self, mock_slide):
    ...
    def test_add_column_chart_creates_chart(self, mock_slide):
