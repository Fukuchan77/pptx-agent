...
class TestTableBuilder:
    ...
    def test_add_simple_table_creates_table_shape(self, mock_slide):
    ...
    def test_add_table_with_many_columns(self, mock_slide):
    ...
    def test_add_table_with_many_rows(self, mock_slide):
    ...
    def test_add_table_with_empty_headers_raises_error(self, mock_slide):
    ...
    def test_add_table_with_mismatched_column_count_raises_error(self, mock_slide):
    ...
    def test_add_single_row_table(self, mock_slide):
